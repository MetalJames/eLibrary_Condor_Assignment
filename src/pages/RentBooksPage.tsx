...
// import SuccessModal from '../components/SuccessModal'; // Adjust the path if necessary
...
//     const bookId = parseInt(query.get('bookId') || '0');
...
//                     <p className="text-gray-700 mb-4">Additional Information: {book.additionalInfo}</p>
//                     <button
